...
static class GameMaster
{
    ...
    public static string Describe(Character character, Destination destination, TravelMethod travelMethod)
    {
        ...
        return $"You're a level {character.Level.ToString()} {character.Class} with {character.HitPoints.ToString()} hit points. You're traveling to your destination {adverb} {travelMethod.ToString()}. You've arrived at {destination.Name}, which has {destination.Inhabitants.ToString()} inhabitants";
